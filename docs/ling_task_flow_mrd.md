...
#### 认证与授权
- **JWT实现**：使用Django REST Framework Simple JWT
- **令牌存储**：前端localStorage存储
- **权限控制**：基于用户身份的资源访问控制
...
- **Quasar Components**：UI组件库
- **shadcn-vue**：高质量UI组件补充
- **Pinia**：状态管理
- **Vue Router**：路由管理
